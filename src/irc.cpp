...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #eggcoincoinTEST\r");
            Send(hSocket, "WHO #eggcoincoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #eggcoincoin\n");
            // randomly join #eggcoincoin00-#eggcoincoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #eggcoincoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #eggcoincoin%02d\r", channel_number).c_str());
        };
